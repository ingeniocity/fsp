 ...
 *     var jsonHtmlTable = ConvertJsonToTable(JSON.parse(dataString), 'jsonTable', null, 'Download');
 *
 * Code sample explaned
 *  - JSON.parse is used to parse a JSON dataString
 *  - table HTML id attribute will be 'jsonTable'
 *  - table HTML class attribute will not be added
 *  - 'Download' text will be displayed instead of the link itself
 *
 * @author G. N. Vashishtha
 * 
                        ...
                        else
                        {
                            if(value){
                            	if(typeof(value) == 'object'){
                            		...
                            		tbCon += tdRow.format(ConvertJsonToTable(JSON.parse(value.data), value.tableId, value.tableClassName, value.linkText));
                            	} else {
