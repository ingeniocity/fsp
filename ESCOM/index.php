       ...
       // function sendingmail(val)
        //{
            ...
            //<?php
              ...
              //  $from = "support@venergysolutions.com"; //$_POST["from"]; // sender
               // $subject = "Repassword";
                //$var2 = genetaedPassword(5);
               // $message = "Mesaage";
                // message lines should not exceed 70 characters (PHP rule), so wrap it
              //  $message = wordwrap($message, 70);
                // send mail
              //  mail($val,$subject,$message,"From: support@venergysolutions.com/n");
    ...
    <body onLoad="load_me_home()">
        ...
        <div class="login_box">
            <form action="index.php" method="post" id="login_form">
                <div class="top_b">Sign in to SLDC Shutdown Protocol</div>    
            ...
            <form action="index.php" method="post" id="pass_form" style="display:none">
                ...
                <div class="btm_b tac">
                    <button class="btn btn-inverse">Request New Password</button>
                </div>  
            </form>
